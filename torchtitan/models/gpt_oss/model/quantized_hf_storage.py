# To allow the gpt-oss model to use the quantized storage reader from PyTorch 2.10,
# we copy this file from PyTorch 2.10.0 commit 449b176. We then reference it rather
# than the standard torch.distributed one in state_dict_adapter.py.
#
# File: torch/distributed/checkpoint/quantized_hf_storage.py
